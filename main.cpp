...
private:
  ...
  void createGraphicsPipeline() {
    ...
    vertShaderStageInfo.pName  = "main"; // Entrypoint function to invoke for shader

    VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
    fragShaderStageInfo.sType  = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    fragShaderStageInfo.stage  = VK_SHADER_STAGE_FRAGMENT_BIT;
    fragShaderStageInfo.module = fragShaderModule;
    fragShaderStageInfo.pName  = "main"; // Entrypoint function to invoke for shader
    ...
    // Describe format of vertex data
    ...
    // Specify what kind of geometry to draw from vertices
    // and if primitive restart shoudl be enabled (e.g. element buffer)
